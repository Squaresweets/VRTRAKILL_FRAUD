...
//            {
//                Vector2 vector = InputVars.TurnVector;
...
//            vector2 = (global::ULTRAKILL.Cheats.Snapping.SnappingEnabled ? SandboxUtils.SnapRotation(vector2) : vector2);
...
//            if (global::ULTRAKILL.Cheats.Snapping.SnappingEnabled)
//            {
...
//            vector3 = global::ULTRAKILL.Cheats.Snapping.SnappingEnabled ? SandboxUtils.SnapRotation(vector3) : vector3;
//            __instance.manipulatedObject.target.eulerAngles = vector3;
//            Vector3 b = Quaternion.Euler(0f, -(__instance.manipulatedObject.originalRotation.y - vector3.y), 0f) * (global::ULTRAKILL.Cheats.Snapping.SnappingEnabled ? SandboxUtils.SnapPos(__instance.manipulatedObject.positionOffset) : __instance.manipulatedObject.positionOffset);
...
//        }
//        float y = InputVars.TurnVector.y;
...
//        vector = SandboxUtils.SnapPos(vector, __instance.brushOffset, global::ULTRAKILL.Cheats.Snapping.SnappingEnabled ? 0.5f : 7.5f);
